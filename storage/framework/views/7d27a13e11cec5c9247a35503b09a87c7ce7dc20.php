...
<html>
    <head>
        ...
        <title><?php echo e($configurations['project_name']); ?> | Faculties</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><i class="fa fa-edit"></i> Faculties</h1>
                    <ol class="breadcrumb">
                            ...
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        <button type="button" class="btn btn-sm btn-primary pull-right" onClick="location.href = '<?php echo e(url('admin/config/faculties/add')); ?>'"><i class="fa fa-plus"></i> Add New</button>
                                    </div>
                                </div>
