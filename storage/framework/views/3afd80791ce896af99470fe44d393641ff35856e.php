...
<html>
    <head>
        ...
        <title><?php echo e($configurations['project_name']); ?> | Curriculums</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><i class="fa fa-edit"></i> Curriculums</h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="col-xs-12">
                            <div class="box box-success">
                                ...
                                <div class="box-body table-responsive">
                                    <?php echo e(Form::open(['url'=>'admin/curriculums/add'])); ?>

                                    <div class="row add-new">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Curriculum Name :</label>
                                                <input type="text" class="form-control" name="CurriculumName" placeholder="Curriculum Name Here...">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Type :</label>
                                                <?php echo e(form::select("Type",$curriculums,null,["class"=>"form-control"])); ?>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <label>
                                                    <?php echo FORM::radio('Status', 0, 0); ?>
                                    ...
                                    <?php echo e(Form::open(['url'=>'admin/curriculums/update','id'=>"frm-update"])); ?>

                                    <input class="id" type="hidden" name="CurriculumID" value="0">
                                    <div class="row update">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Curriculum Name :</label>
                                                <input type="text" class="form-control curriculum_name" name="CurriculumName" placeholder="Curriculum Name Here...">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Type :</label>
                                                <?php echo e(form::select("Type",$curriculums,null,["class"=>"form-control type"])); ?>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <label>
                                                    <?php echo FORM::radio('Status', 1, 0,['class'=>'status-1']); ?>

                                                    Active
                                                </label>
                                                <br>
                                                <label>
                                                    <?php echo FORM::radio('Status', 0, 0,['class'=>'status-0']); ?>
                                    ...
                                    <?php echo e(Form::open(['url'=>'admin/curriculums/delete','id'=>'frm_list'])); ?>
        ...
        <script language="javascript">
                                            ...
                                            function edit(id,curriculum_name,type,status){
                                                $(".add-new").hide();
                                                $(".update").show();
