...
<html>
    <head>
        ...
        <title><?php echo e($configurations['project_name']); ?> | Expenses</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><i class="fa fa-edit"></i> Expenses</h1>
                    <ol class="breadcrumb">
                        <li><a href="<?php echo e(url('admin')); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Expenses</li>
                    </ol>
                </section>
                <?php echo Form::open([ 'url' => 'admin/expenses/delete', 'id' => 'frm_list' ]); ?>
                            ...
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        <button type="button" class="btn btn-sm btn-primary" onClick="location.href='expenses/add'"><i class="fa fa-plus"></i> Add</button>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-md-4">
                                            <h3>Total Expense: <span style="font-size:120%; font-weight: bold;" id="totalAmount"></span></h3>
                                        </div>
                                    </div>
