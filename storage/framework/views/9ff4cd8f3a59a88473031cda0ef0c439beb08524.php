<?php use App\Http\Controllers\Admin\MarkAttendance; ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="wrapper"> <?php echo $__env->make('admin/includes/header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <div class="content-wrapper" style="background:#fff;">
                ...
                <section class="content ">
                    <?php echo Form::open([ 'url' => 'admin/view-attendance', 'class' => 'print-hidden']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo Form::text('Month', $date, ['placeholder' => 'Select Month', 'class' => 'form-control date', 'id' => 'Month']); ?>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>&nbsp;</label>
                                <button type="submit" class="btn btn-success form-control">Get Attendance Sheet</button>
                            </div>
                        </div>
                    </div>
                    <?php echo FORM::close(); ?>
                    ...
                    <div class="row timetable">
                        <div class="col-md-12">
                            ...
                            if (isset($attendance['Batch']) && count($attendance['Batch']) > 0) {
                                ?>
                                <input type="hidden" name="BatchID" value="<?php echo e($attendance['Batch']['BatchID']); ?>">
                                <input type="hidden" name="ModuleID" value="<?php echo e($attendance['Batch']['ModuleID']); ?>">
                                <input type="hidden" name="FacultyID" value="<?php echo e($attendance['Batch']['FacultyID']); ?>">
                                <table class="table table-bordered">
                                    ...
                                    <?php
                                    $cnt = 1;
                                    foreach ($attendance['Batch']['Students'] as $index => $stud) {
                                        ?>
                                        <tr class="mCols">
                                            ...
                                            foreach ($attendance['Batch']['DaysDates'] as $day) {
                                                ?>
                                            <th class="txt-center">
                                                <?php echo e($attendances[MarkAttendance::get_attendance($stud->StudentID,$attendance['Batch']['BatchID'],$attendance['Batch']['ModuleID'],$day['Session'],$day['FD'])]); ?>
                                    ...
                                    <tr class="mCols">
                                        ...
                                        <?php
                                            ...
                                            foreach ($attendance['Batch']['DaysDates'] as $day) {
                                                ?>
                                            <th class="txt-center">
                                                <?php echo e($attendances[MarkAttendance::get_faculty_attendance($attendance['Batch']['FacultyID'],$attendance['Batch']['BatchID'],$attendance['Batch']['ModuleID'],$day['Session'],$day['FD'])]); ?>
