...
<html>
    <head>
        ...
        <title><?php echo e($configurations['project_name']); ?> | Days</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><i class="fa fa-edit"></i> Days</h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="col-xs-12">
                            <div class="box box-success">
                                ...
                                <div class="box-body table-responsive">
                                    <?php echo e(Form::open(['url'=>'admin/days/add'])); ?>

                                    <div class="row add-new">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Days :</label>
                                                <input type="text" class="form-control" name="Days" placeholder="Days Here...">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Details :</label>
                                                <textarea class="form-control details" rows="2" placeholder="Details Here..." name="Details"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                    ...
                                    <?php echo e(Form::open(['url'=>'admin/days/update','id'=>"frm-update"])); ?>

                                    <input class="id" type="hidden" name="DaysID" value="0">
                                    <div class="row update">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Days :</label>
                                                <input type="text" class="form-control days" name="Days" placeholder="Days Here...">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <?php echo e(Form::open(['url'=>'admin/days/delete','id'=>'frm_list'])); ?>
        ...
        <script language="javascript">
                                            ...
                                            function edit(id,days,details,status){
                                                $(".add-new").hide();
                                                $(".update").show();
                                                $(".days").val(days);
                                                $(".details").val(details);
