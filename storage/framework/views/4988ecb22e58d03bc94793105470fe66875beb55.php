...
<html>
    <head>
        ...
        <title><?php echo e($configurations['project_name']); ?> | Users</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <!-- Main content -->
                <?php echo Form::open([ 'url' => 'admin/users/delete', 'id' => 'frm_list' ]); ?>
                            ...
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        <button type="button" class="btn btn-sm btn-primary" onClick="location.href = '<?php echo e(url('admin/users/add')); ?>'"><i class="fa fa-plus"></i> Add New</button>
        ...
        <script language="javascript">
                                            ...
                                            function doDelete()
                                            {
                                                if (checkboxes.filter(':checked').length > 0)
                                                {
                                                    ...
                                                    message_box("Confirm", "This will delete all Clients.<br>Are you sure?", "confirm", ok, null);
                                                } else
                                                {
