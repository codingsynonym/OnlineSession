        ...
        <div class="wrapper"> <?php echo $__env->make('admin/includes/header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <div class="content-wrapper" style="background:#fff;">
                ...
                <section class="content">
                    <form method="get" action="<?php echo e(url('admin/internal-fee-not-paid')); ?>">
                        <div class="row">
                            <div class="col-md-4">
                                <input type="text" name="CommitmentDateStart" autocomplete="off" value="<?php echo e($CommitmentDateStart); ?>" placeholder="Select Date From" class="form-control datepicker" />
                            </div>
                            <div class="col-md-4">
                                <input type="text" name="CommitmentDateEnd" autocomplete="off" value="<?php echo e($CommitmentDateEnd); ?>" placeholder="Select Date To" class="form-control datepicker" />
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            ?>
                            <h3 style="border-bottom:2px solid #333; margin-bottom: 3px; padding-bottom: 4px;">Total Internal <span style="font-weight:bold">Rs. <?php echo e(number_format($TotalInternal, 0)); ?> (<?php echo e($MyCount); ?>)</span></h3>
                            ...
                            <div class="row">
                                ...
                                foreach ($StatusesSum as $statIndx => $statsSum) {
                                    ...
                                    <div class="col-md-4">
                                        <div>
                                            <h4><?php echo e($statIndx); ?>: <span style="font-weight:bold">Rs. <?php echo e(number_format($statsSum, 0)); ?> (<?php echo e($HeadCounts[$statIndx]); ?>) <?php echo e(number_format(($statsSum / $TotalInternal * 100),2)); ?>%</span></h4>
                                        </div>
                                    </div>
                                    <?php
                                }
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2 style="font-weight: 900; color: #595959;"><center>Faculty (Internal Not Received)</center></h2>
                        </div>
                        <?php
                        $a_num = 1;
                        foreach ($FacultyData as $facid => $fac_data) {
                            ...
                            <div class="col-md-4">
                                <div style="border:1px solid #333; margin-bottom: 20px; padding: 0 10px;">
                                    <h3 style="border-bottom:2px solid #333; margin-bottom: 3px; padding-bottom: 4px; font-size: 18px;"><a href="<?php echo e(url('admin/internal-fee-not-paid?FacultyID='.$facid)); ?>"><?php echo e($FacultyNames[$facid]); ?> <span style="font-weight:bold">Rs. <?php echo e(number_format($FacultyAmountTotal[$facid], 0)); ?> (<?php echo e($FacultyCountTotal[$facid]); ?>) <?php echo e(number_format(($FacultyAmountTotal[$facid] / $TotalInternal * 100),2)); ?>%</span></a></h3>
                                    <div style="border-bottom:2px solid #333; margin-bottom: 12px;"></div>
                                    <div class="row">
                                        <?php
                                        foreach ($fac_data as $statIndx => $statsSum) {
                                            ...
                                            <div class="col-md-12">
                                                <div>
                                                    <h4 style="margin:0 0 10px 0; font-size: 15px;"><?php echo e($statIndx); ?>: <span style="font-weight:bold">Rs. <?php echo e(number_format($statsSum, 0)); ?> (<?php echo e($FacultyDataCount[$facid][$statIndx]); ?>) <?php echo e(number_format(($statsSum / $FacultyAmountTotal[$facid] * 100),2)); ?>%</span></h4>
                                                </div>
                                            </div>
                                            <?php
                                        }
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2 style="font-weight: 900; color: #595959;"><center>Batch Time (Internal Not Received)</center></h2>
                        </div>
                        <?php
                        $b_num = 1;
                        foreach ($DaysTimeData as $daytime => $time_data) {
                            ...
                            <div class="col-md-4">
                                <div style="border:1px solid #333; margin-bottom: 20px; padding: 0 10px;">
                                    <h3 style="border-bottom:2px solid #333; margin-bottom: 3px; padding-bottom: 4px; font-size: 18px;"><a href="<?php echo e(url('admin/internal-fee-not-paid?DaysTime='.$daytime)); ?>"><?php echo e($daytime); ?> <span style="font-weight:bold">Rs. <?php echo e(number_format($DaysTimeTotal[$daytime], 0)); ?> (<?php echo e($DaysTimeTotalCount[$daytime]); ?>) <?php echo e(number_format(($DaysTimeTotal[$daytime] / $TotalInternal * 100),2)); ?>%</span></a></h3>
                                    <div style="border-bottom:2px solid #333; margin-bottom: 12px;"></div>
                                    <div class="row">
                                        <?php
                                    ...
                                    foreach ($ActiveStudents as $reasonIndex => $stdudents) {
                                        ...
                                        foreach ($stdudents as $std) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="student-status" nme="<?php echo e($std['StudentName']); ?>" val="<?php echo e($std['StudentID']); ?>"><?php echo e($std['StudentName']); ?></td>
                                                <td style="color:#21ce26; font-weight: bold;"><?php echo e($std['CommitmentDate']); ?></td>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div id="mssg"></div>
                            <h3 class="text-center" id="StudentName"></h3>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo Form::textarea('Reason', null, ['placeholder' => 'Enter Comment', 'class' => 'form-control', 'id' => 'Reason', 'rows' => '3']); ?>

                            </div>
                            <div class="form-group">
                                <label for="CommitmentDate">Commitment Date: <span class="mandatory">*</span></label>
                                <?php echo Form::text('CommitmentDate', null, ['placeholder' => 'Select Commitment Date', 'class' => 'form-control datepicker', 'id' => 'CommitmentDate', 'autocomplete' => 'off']); ?>

                            </div>
                            <div class="form-group">
                                <label for="Dated">Dated: <span class="mandatory">*</span></label>
                                <?php echo Form::text('Dated', null, ['placeholder' => 'Select Comment Date', 'class' => 'form-control datepicker', 'id' => 'Dated', 'autocomplete' => 'off']); ?>
...
//        },
    ...
    $('.student-status').click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('admin/internal-report/get-status')); ?>",
            ...
            success: function (data) {
                if (data.Status) {
                    ...
                    $('#CommitmentDate').val(data.Reason.CommitmentDate);
                    $('#Dated').val(data.Reason.Dated);
                }
            },
            complete: function () {
...
//    console.log(CommitmentDate);
    ...
    if (StudentID != "0" && ReasonID != "" && CommitmentDate != "" && Dated != "" && Reason != "") {
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('admin/internal-report/set-status')); ?>",
            'headers': {'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'},
            data: {StudentID: StudentID, ReasonID: ReasonID, CommitmentDate: CommitmentDate, Reason: Reason, Dated: Dated},
            dataType: "JSON",
            success: function (data) {
                if (data.Status) {
                    $('#mssg').removeClass('errorBox');
                    $('#mssg').addClass('successBox');
                    location.href = '<?php echo e(url("admin/internal-fee-not-paid")); ?>';
                } else {
        ...
        $('#mssg').removeClass('successBox');
        $('#mssg').addClass('errorBox');
        $('#mssg').html("Please select reason and date");
    }
});
        </script>
